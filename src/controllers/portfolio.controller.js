...
var PortfolioController = /** @class */ (function () {
     ...
     */
    PortfolioController.prototype.getPortfolioPerformance = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, timeframe, result, error_1, errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, portfolio_service_1.portfolioService.getPortfolioPerformance(userId, timeframe)];
                    case 1:
                        result = _a.sent();
                        if (result.success) {
