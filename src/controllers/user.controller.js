...
var UserController = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userId = req.userId;
                        return [4 /*yield*/, user_service_1.userService.getUserProfile(userId)];
                    case 1:
                        result = _a.sent();
                        if (result.success) {
     ...
     */
    UserController.prototype.getLinkedAccounts = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userId = req.userId;
                        return [4 /*yield*/, user_service_1.userService.getLinkedAccounts(userId)];
                    case 1:
                        result = _a.sent();
                        if (result.success) {
                            res.status(200).json(result);
     ...
     */
    UserController.prototype.getBeneficiaries = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userId = req.userId;
                        return [4 /*yield*/, user_service_1.userService.getBeneficiaries(userId)];
                    case 1:
                        result = _a.sent();
                        if (result.success) {
                            res.status(200).json(result);
