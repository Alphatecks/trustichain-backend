...
var NotificationController = /** @class */ (function () {
    ...
    NotificationController.prototype.getNotifications = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, filter, page, pageSize, result, error_1, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, notification_service_1.notificationService.getNotifications({
                                userId: userId,
                                filter: filter,
                                page: page,
                                pageSize: pageSize,
     ...
     */
    NotificationController.prototype.markAsRead = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, id, result, error_2, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userId = req.userId;
                        id = req.params.id;
                        return [4 /*yield*/, notification_service_1.notificationService.markAsRead(userId, id)];
                    case 1:
                        result = _a.sent();
                        if (result.success) {
                            res.status(200).json(result);
     ...
     */
    NotificationController.prototype.markAllAsRead = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, result, error_3, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
